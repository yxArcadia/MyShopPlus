...
import cn.yxvk.myshop.plus.dto.FileInfo;
...
/**
 * @author yangxiang
 * @date 2019/11/26 18:23
 */
@RestController
@RequestMapping(value = "upload")
public class UploadController {
    private static final String ENDPOINT = "oss-cn-hongkong.aliyuncs.com";
    private static final String ACCESS_KEY_ID = "LTAI4FwJQUU2qjDGqAp8omWf";
    private static final String ACCESS_KEY_SECRET = "ZCpqOG9QiM56eEPDVrz9SxvITL87nF";
    private static final String BUCKET_NAME = "yx-myshop";
    /**
     * 文件上传
     *
    ...
    public ResponseResult<FileInfo> upload(MultipartFile multipartFile) {
        ...
        try {
            ...
            return new ResponseResult<>(HttpStatus.OK.value(), "文件上传成功", new FileInfo("http://" + BUCKET_NAME + "." + ENDPOINT + "/" + newName));
        } catch (IOException e) {
            return new ResponseResult<>(HttpStatus.BAD_REQUEST.value(), "文件上传失败，请重试");
        } finally {
            client.shutdown();
        }
    }
